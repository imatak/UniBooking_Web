          ...
          <v-container fluid>
            <v-layout row>
              <v-flex xs7 sm8 md9>
                ...
                <v-card-actions>
                  <v-btn class="green" dark @click.native="onOdobri(event.id)">Odobri
                    <v-icon dark right>check_circle</v-icon>
                  </v-btn>
                  <v-btn class="red" dark @click.native="onOtkazi(event.id)">Otkaži
                ...
                <v-card-title>
                <div>
                <h5 class="white--text mb-0"><v-icon large class="white--text">event_note</v-icon> {{ event.status }}</h5>
